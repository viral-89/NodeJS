...
// });
// issue: everytime you run the file that put new data with existing data, so that print same data everytime you run the file
...
//   if (e) throw error;
//   console.log("File Copy Succesfully`");
// });
